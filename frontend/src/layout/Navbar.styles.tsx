...
export const Brand = styled(Link).attrs({ scroll: false })`
...
export const NavLink = styled(Link).attrs({ scroll: false })`
  white-space:nowrap;
...
export const PanelLink = styled(Link).attrs({ scroll: false })`
...
export const MobileLink = styled(Link).attrs({ scroll: false })`
