...
VALUES
(@ASSET_HERO_ID, NULL, 'hero.jpg', 'public', 'references/hero.jpg', 'references', 'image/jpeg', 245120, NULL, NULL, NULL, NULL,
 'cloudinary', 'references/hero', 'image', 'jpg', 1, NULL, NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 mime=VALUES(mime), size=VALUES(size), url=VALUES(url), provider_format=VALUES(provider_format), updated_at=VALUES(updated_at);
...
(id, user_id, `name`, bucket, `path`, folder, mime, size, width, height, url, hash,
 provider, provider_public_id, provider_resource_type, provider_format, provider_version, etag, metadata, created_at, updated_at)
VALUES
(@ASSET_REF1_ID, NULL, 'ref1.jpg', 'public', 'references/ref1.jpg', 'references', 'image/jpeg', 180300, NULL, NULL, NULL, NULL,
 'cloudinary', 'references/ref1', 'image', 'jpg', 1, NULL, NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 mime=VALUES(mime), size=VALUES(size), url=VALUES(url), provider_format=VALUES(provider_format), updated_at=VALUES(updated_at);
...
(id, user_id, `name`, bucket, `path`, folder, mime, size, width, height, url, hash,
 provider, provider_public_id, provider_resource_type, provider_format, provider_version, etag, metadata, created_at, updated_at)
VALUES
(@ASSET_REF2_ID, NULL, 'ref2.jpg', 'public', 'references/ref2.jpg', 'references', 'image/jpeg', 171550, NULL, NULL, NULL, NULL,
 'cloudinary', 'references/ref2', 'image', 'jpg', 1, NULL, NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 mime=VALUES(mime), size=VALUES(size), url=VALUES(url), provider_format=VALUES(provider_format), updated_at=VALUES(updated_at);
...
(id, user_id, `name`, bucket, `path`, folder, mime, size, width, height, url, hash,
 provider, provider_public_id, provider_resource_type, provider_format, provider_version, etag, metadata, created_at, updated_at)
VALUES
(@ASSET_G1A_ID, NULL, 'g1a.jpg', 'public', 'references/g1a.jpg', 'references', 'image/jpeg', 200000, NULL, NULL, NULL, NULL,
 'cloudinary', 'references/g1a', 'image', 'jpg', 1, NULL, NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 mime=VALUES(mime), size=VALUES(size), url=VALUES(url), provider_format=VALUES(provider_format), updated_at=VALUES(updated_at);
...
(id, user_id, `name`, bucket, `path`, folder, mime, size, width, height, url, hash,
 provider, provider_public_id, provider_resource_type, provider_format, provider_version, etag, metadata, created_at, updated_at)
VALUES
(@ASSET_G1B_ID, NULL, 'g1b.jpg', 'public', 'references/g1b.jpg', 'references', 'image/jpeg', 210000, NULL, NULL, NULL, NULL,
 'cloudinary', 'references/g1b', 'image', 'jpg', 1, NULL, NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 mime=VALUES(mime), size=VALUES(size), url=VALUES(url), provider_format=VALUES(provider_format), updated_at=VALUES(updated_at);
...
(id, user_id, `name`, bucket, `path`, folder, mime, size, width, height, url, hash,
 provider, provider_public_id, provider_resource_type, provider_format, provider_version, etag, metadata, created_at, updated_at)
VALUES
(@ASSET_G2A_ID, NULL, 'g2a.jpg', 'public', 'references/g2a.jpg', 'references', 'image/jpeg', 205000, NULL, NULL, NULL, NULL,
 'cloudinary', 'references/g2a', 'image', 'jpg', 1, NULL, NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 mime=VALUES(mime), size=VALUES(size), url=VALUES(url), provider_format=VALUES(provider_format), updated_at=VALUES(updated_at);
