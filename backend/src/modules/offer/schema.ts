...
export const offerNumberCountersTable = mysqlTable(
  "offer_number_counters",
  {
...
export type OfferNumberCounterRow =
  typeof offerNumberCountersTable.$inferSelect;
export type NewOfferNumberCounterRow =
  typeof offerNumberCountersTable.$inferInsert;
